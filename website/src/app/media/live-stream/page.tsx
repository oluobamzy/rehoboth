          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="aspect-w-16 aspect-h-9 bg-gray-900">
              ...
              <div className="flex items-center justify-center h-96 bg-gray-800 text-white">
                <div className="text-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-20 w-20 mx-auto mb-4 text-blue-600" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                  </svg>
                  <h3 className="text-xl font-bold mb-2">YouTube Live Stream</h3>
                  <p className="text-gray-300 mb-4">
                    {isLive ? 'Join our live service now!' : 'Stream will appear here during service times'}
                  </p>
                  <a
                    href="https://youtube.com/@rehobothchurch"
                    target="_blank"
            ...
            <div className="p-6">
              <h2 className="text-2xl font-bold text-gray-900 mb-2">
                {isLive ? 'Live Service' : 'Rehoboth Christian Church'}
              </h2>
              <p className="text-gray-600">
                Experience worship with us online. Whether you're at home or traveling, you're always welcome to join our church family.
              </p>
            </div>
          </div>
        </div>
