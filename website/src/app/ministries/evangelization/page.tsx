...
export default function EvangelizationMinistryPage() {
  const activities = [
    "Community evangelism and outreach programs",
    "Door-to-door visitation and witnessing",
    "Evangelistic events and crusades",
    "Training for personal evangelism",
    "Partnership with local missions"
  ];
      ...
      <div className="bg-gradient-to-r from-blue-600 to-emerald-500 text-white">
        <div className="container mx-auto px-4 py-20">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Evangelization Ministry</h1>
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
              Sharing the Gospel of Jesus Christ with our community and beyond
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 leading-relaxed mb-8">
            Reaching the lost with the love of Christ through personal witness, community outreach, and strategic evangelism.
          </p>
        </div>
      </div>
