...
export default function MusicMinistryPage() {
  const activities = [
    "Choir and worship team training",
    "Music education and instrument lessons",
    "Special music performances and concerts",
    "Sound system operation and technical support",
    "Coordination of worship services music"
  ];
      ...
      <div className="bg-gradient-to-r from-blue-600 to-emerald-500 text-white">
        <div className="container mx-auto px-4 py-20">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Music Ministry</h1>
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
              Worshipping God through music and equipping others to serve in musical ministry
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 leading-relaxed mb-8">
            Leading the congregation in worship and developing musical talents for God's glory and service to the church.
          </p>
        </div>
      </div>
