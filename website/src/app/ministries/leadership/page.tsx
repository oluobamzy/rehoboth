...
export default function LeadershipMinistryPage() {
  const activities = [
    ...
    "Elder and deacon development seminars", 
    "Ministry team leadership workshops",
    "Spiritual mentorship opportunities",
    "Church governance and administration training"
  ];
      ...
      <div className="bg-gradient-to-r from-blue-600 to-emerald-500 text-white">
        <div className="container mx-auto px-4 py-20">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Leadership Ministry</h1>
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
              Developing servant leaders for God's kingdom
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 leading-relaxed mb-8">
            Equipping and empowering leaders to serve God's kingdom with integrity, wisdom, and passion.
          </p>
        </div>
      </div>
