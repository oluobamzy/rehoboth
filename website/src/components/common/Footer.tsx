    ...
    <footer className="bg-gray-900 text-white py-8 md:py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              />
              <h3 className="text-lg font-bold">{settings.church_name}</h3>
            </div>
            <p className="mb-4">{settings.church_description}</p>
            <div className="flex space-x-4">
              {settings.facebook_url && (
                <a href={settings.facebook_url} className="text-gray-300 hover:text-white" target="_blank" rel="noopener noreferrer">
              ...
              {settings.instagram_url && (
                <a href={settings.instagram_url} className="text-gray-300 hover:text-white" target="_blank" rel="noopener noreferrer">
              ...
              {settings.youtube_url && (
                <a href={settings.youtube_url} className="text-gray-300 hover:text-white" target="_blank" rel="noopener noreferrer">
              ...
              {settings.twitter_url && (
                <a href={settings.twitter_url} className="text-gray-300 hover:text-white" target="_blank" rel="noopener noreferrer">
          ...
          <div>
            ...
            {Object.entries(settings.service_times).map(([day, time]) => (
              <p key={day} className="text-gray-300 mb-2 capitalize">
                {day}: {time}
              </p>
            ))}
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 text-center">
          <p className="text-gray-400">© {currentYear} {settings.church_name}. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
